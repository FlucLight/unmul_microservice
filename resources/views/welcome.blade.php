  ...
  <div class="modal-overlay" id="loginModalOverlay">
    <div class="modal-card">
      ...
      <div class="modal-view" id="loginView">
        ...
        <p class="auth-footer-text">Akun LMS hanya dapat dibuat oleh <strong>Operator Fakultas</strong>.<br>
          <a href="https://wa.me/6287721685155?text=Halo%20Admin%2FOperator%2C%20saya%20ingin%20mengajukan%20pembuatan%20akun%20LMS.%20Berikut%20data%20diri%20saya%3A%0A%0ANama%20Lengkap%3A%20%0AStatus%20Registrasi%20(Mahasiswa%2FDosen)%3A%20%0ANomor%20Induk%20(NIM%2FNIP)%3A%20%0AEmail%20Aktif%3A%20%0APassword%20yang%20diinginkan%3A%20%0A%0AMohon%20bantuannya%20untuk%20dibuatkan%20akun.%20Terima%20kasih"
            target="_blank" rel="noopener noreferrer"
            class="inline-flex items-center justify-center gap-2 mt-2 px-4 py-2 rounded-full bg-[#25D366]/10 border border-[#25D366]/40 text-[#128C7E] hover:bg-[#25D366] hover:border-[#25D366] hover:text-white transition font-bold text-xs">
