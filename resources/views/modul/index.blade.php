            ...
            <div class="flex items-center justify-between h-16 gap-4">
                ...
                <div class="flex items-center gap-3 sm:gap-6 min-w-0">
                    ...
                    <div class="flex items-center gap-1 bg-slate-100 dark:bg-slate-800/90 p-1 rounded-xl border border-slate-200 dark:border-slate-700/80 text-xs font-semibold shadow-inner">
                        ...
                        <a href="{{ route('modul.index') }}" class="page-switch-link px-3 sm:px-3.5 py-1.5 rounded-lg bg-gradient-to-r from-[#FF7A00] to-[#FF9225] text-white font-bold shadow-md shadow-orange-500/20 flex items-center gap-1.5 no-underline active-tab">
